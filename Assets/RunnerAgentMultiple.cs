    ...
    public class RunnerAgentMultiple : Agent
    {
        private playermovementMultiple movement;
        ...
        {
            movement = GetComponent<playermovementMultiple>();
...
movement.playerPosition = randomLane;
lastZPosition = startZ;
playermovementMultiple move = GetComponent<playermovementMultiple>();
        if (move != null)
        {
            move.ResetPosition(startZ);
        }
